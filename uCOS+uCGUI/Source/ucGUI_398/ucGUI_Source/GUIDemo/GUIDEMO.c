...
void GUIDEMO_main(void) {
  ...
  GUI_Clear();
    ...
    _ahFrameWin[1] = FRAMEWIN_Create("www.ourdev.com", NULL, WM_CF_SHOW | WM_CF_STAYONTOP,	 ///////////////////////////////////
                                                LCD_GetXSize() - 80, LCD_GetYSize() - 60, 80, 60);   /////80
  ...
  GUIDEMO_Intro();
    ...
    _ahFrameWin[0] = FRAMEWIN_Create("www.ouravr.com is very good", NULL, WM_CF_STAYONTOP, //	µC/GUI Demo
